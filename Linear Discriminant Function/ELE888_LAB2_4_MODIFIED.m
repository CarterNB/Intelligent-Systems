...
function [a,g,k]=ELE888_LAB2_4_MODIFIED(Training_Data)
...
testSet=[setB(1:15,1:2);setC(1:15,1:2)];
trainSet=[setB(16:50,1:2);setC(16:50,1:2)];
k=0;
a=[0 0 1]';
theta=0;
eta=0.01;
...
g=a'*aug_testSet
misclassB=length(find(g(1:15)<0))
misclassC=length(find(g(16:30)>0))
...
subplot(2,1,2);
plot(n, Jpa);
title("Perceptron Criterion Function J_p(a) for Iris Versicolour vs. Iris Virginia (70% Training)");
xlabel("k iterations");
ylabel("J_p(a)");